...
const aboutMeText =
  `Nice to meet you!<br /> I'm a musician currently attending a Software Engineering bootcamp at General Assembly.<br /> I love simple and efficient code, minimal and powerful design, and loud but pretty music.<br /> I always aim to make my projects accessible and inclusive.<br /><br /> Please reach out on my contact page if you would like to connect or know more!<br /> <br />If you click the buttons on the bottom left you can hear some of my music! Samsara is from my last band Angel Aura, and Hourglass is an instrumental song from my solo project Split Signal.</p>`;
